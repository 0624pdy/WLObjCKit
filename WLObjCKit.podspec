...
Pod::Spec.new do |s|
  s.name             = 'WLObjCKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of WLObjCKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/0624pdy@sina.com/WLObjCKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '0624pdy@sina.com' => 'pengduanyang@jze100.com' }
  s.source           = { :git => 'https://github.com/0624pdy@sina.com/WLObjCKit.git', :tag => s.version.to_s }
